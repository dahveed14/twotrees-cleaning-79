        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                src="/lovable-uploads/75bded66-c848-4790-a808-6efcbd3b250f.jpg"
            ...
            <Card className="hover:shadow-lg transition-shadow border-none shadow-md">
              <CardContent className="p-6 text-center">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link to="/santa-barbara"> house cleaning services</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow border-none shadow-md">
              <CardContent className="p-6 text-center">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link to="/thousand-oaks"> house cleaning services</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600">
              3445 Telegraph Rd, Suite 103, Ventura, CA 93003
            </p>
          </div>
          <div className="rounded-2xl overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps?q=3445+Telegraph+Rd+Suite+103+Ventura+CA+93003&output=embed"
              width="100%" 
              height="450" 
              style={{ border: 0 }} 
              allowFullScreen 
