        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold text-two-trees-green mb-4">
              Visit Our Ventura Office
            </h2>
            <p className="text-xl text-gray-600">
              2252 Channel Dr, Ventura, CA 93001
            </p>
          </div>
          <div className="rounded-2xl overflow-hidden shadow-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8950.374799972677!2d-119.27136054354615!3d34.27142549198656!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80e9ad24e50049e3%3A0xf50c60a11af645e5!2s2252%20Channel%20Dr%2C%20Ventura%2C%20CA%2093001!5e0!3m2!1sen!2sus!4v1770162985658!5m2!1sen!2sus" 
              width="100%" 
              height="450" 
              style={{ border: 0 }} 
              allowFullScreen 
              ...
              title="Two Trees Cleaning Ventura Office Location"
            />
          </div>
        </div>
      </section>
