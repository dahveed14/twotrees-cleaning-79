  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta name="description" content="Premium house cleaning services in Santa Barbara and Goleta, CA. Luxury home care with meticulous attention to detail. Licensed, insured & trusted by discerning homeowners. Call 805-436-5868" />
