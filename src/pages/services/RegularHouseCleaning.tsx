...
import { Phone, CheckCircle, Clock, Shield, Star, BookOpen, ArrowRight } from "lucide-react";
          ...
          <div className="mb-16 flex justify-center">
            <div className="max-w-lg p-6 bg-primary/5 border border-primary/20 rounded-xl text-center">
              ...
              <p className="text-muted-foreground mb-4 text-sm">
                See our comprehensive guide detailing what's included (and what's not) in each cleaning service
              </p>
